          ...
          <div class="pt-[3rem] px-[2rem]">
            <div class="flex flex-col gap-[2rem]">
              <div>
                ...
                <input id="first_name" autocomplete="on" v-model="guest.first_name" placeholder="first name" required class="h-[3rem] w-[16rem] px-2 border border-gray-400 rounded-md"/>
              </div>
              <div>
                <label for="last_name">
                  <p class="text-gray-400">Last name:</p>
                </label>
                <input id="last_name" autocomplete="on" v-model="guest.last_name" placeholder="last name" required class="h-[3rem] w-[16rem] px-2 border border-gray-400 rounded-md"/>
              </div>
              <div>
                <label for="email">
                  <p class="text-gray-400">Email:</p>
                </label>
                <input id="email" autocomplete="on" v-model="guest.email" placeholder="email" required type="email" class="h-[3rem] w-[16rem] px-2 border border-gray-400 rounded-md"/>
              </div>
            </div>
            </div>
